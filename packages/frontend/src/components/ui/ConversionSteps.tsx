...
const ConversionSteps: React.FC<ConversionStepsProps> = ({ currentStep, className }) => {
  ...
  const steps: { id: ConversionStep; label: string; description: string }[] = [
    {
      id: 'select',
      label: 'Select File',
          ...
          return (
            <React.Fragment key={step.id}>
              ...
              <div className="flex flex-col items-center">
                <div 
                  className={cn(
                    'flex items-center justify-center w-8 h-8 rounded-full border-2 text-sm font-semibold mb-2 transition-all duration-300',
                ...
                <div className="w-full max-w-[100px] lg:max-w-none flex-grow mx-2 h-[2px] bg-gray-200 overflow-hidden">
                  <div 
                    className={cn(
                      ...
                      animateStep === steps[index + 1]?.id && 'animate-progress-pulse'
                    )}
      ...
      <div className="sm:hidden">
        <div className="flex justify-between items-center bg-gray-50 rounded-lg p-3">
          <div className="flex items-center">
            <div 
              className={cn(
                'flex items-center justify-center w-8 h-8 rounded-full border-2 text-sm font-semibold mr-3',
